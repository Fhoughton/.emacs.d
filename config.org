...
*** Dumb Jump
A simple setup to jump to the definition of symbols whilst programming
...
#+begin_src emacs-lisp
  ...
  (use-package org-download
    ...
    :bind ((:map org-mode-map (("C-c p". org-download-screenshot)))))
  ...
  (global-set-key (kbd "C-c i") 'insert-image)
#+end_src
